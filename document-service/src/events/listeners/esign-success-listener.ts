...
import {} from 'document-service/document/models';
import { IDocumentActions } from 'document-service/document/models/Actions';
import AuditTrail, {
  IAuditTrail,
} from 'document-service/document/models/AuditTrail';
import Document from 'document-service/document/models/Document';
import DocumentUserMap from 'document-service/document/models/DocumentUserMap';
...
import { SendEmailPublisher } from 'document-service/events/publishers';
